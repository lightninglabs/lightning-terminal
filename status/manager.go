...
// with no errors. This will silently fail if the referenced sub-server has not
// yet been registered.
...
// and also to set an error message for the sub-server. This will silently fail
// if the referenced sub-server has not yet been registered.
