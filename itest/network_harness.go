...
func (n *NetworkHarness) SetUp(t *testing.T,
	...
	eg.Go(func() error {
		var err error
		n.Alice, err = n.NewNode("Alice", lndArgs, false, true)
		return err
	})
	eg.Go(func() error {
		var err error
		n.Bob, err = n.NewNode("Bob", lndArgs, true, true)
		return err
	})
...
func (n *NetworkHarness) NewNode(name string, extraArgs []string,
	...
	return n.newNode(name, extraArgs, litArgs, false, remoteMode, nil, wait)
}
