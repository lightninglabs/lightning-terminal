...
// testCustomChannelsPassiveAssets tests that passive assets (assets in the same
// input commitment but not used for channel funding) are not incorrectly
// included in the funding proofs sent to the responder
