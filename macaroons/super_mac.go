...
// ValidateSuperMacaroonPath checks that the super macaroon path ends with the
// expected suffix.
func ValidateSuperMacaroonPath(path string) error {
	if path != "" && !strings.HasSuffix(path, ".macaroon") {
