...
goog.object.extend(proto, lit$sessions_pb);
...
proto.litrpc.AddAutopilotSessionRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    devServer: jspb.Message.getBooleanFieldWithDefault(msg, 4, false),
    ...
    noPrivacyMapper: jspb.Message.getBooleanFieldWithDefault(msg, 7, false),
    linkedGroupId: msg.getLinkedGroupId_asB64(),
    privacyFlags: jspb.Message.getFieldWithDefault(msg, 9, "0"),
    privacyFlagsSet: jspb.Message.getBooleanFieldWithDefault(msg, 10, false)
  };
  ...
  while (reader.nextField()) {
    ...
    case 5:
      ...
      reader.readMessage(value, function(message, reader) {
        jspb.Map.deserializeBinary(message, reader, jspb.BinaryReader.prototype.readString, jspb.BinaryReader.prototype.readMessage, proto.litrpc.FeatureConfig.deserializeBinaryFromReader, "", new proto.litrpc.FeatureConfig());
         });
      break;
    case 6:
...
/**
 * @param {string} value
 * @return {!proto.litrpc.AddAutopilotSessionRequest} returns this
 */
...
proto.litrpc.AddAutopilotSessionRequest.prototype.clearSessionRules = function() {
  return this.setSessionRules(undefined);
};
...
/**
 * @param {?proto.litrpc.RulesMap|undefined} value
 * @return {!proto.litrpc.FeatureConfig} returns this
*/
 ...
 * @return {!proto.litrpc.ListAutopilotSessionsResponse} returns this
*/
 ...
 * @return {!proto.litrpc.AddAutopilotSessionResponse} returns this
*/
...
proto.litrpc.ListAutopilotFeaturesResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      var value = msg.getFeaturesMap();
      reader.readMessage(value, function(message, reader) {
        jspb.Map.deserializeBinary(message, reader, jspb.BinaryReader.prototype.readString, jspb.BinaryReader.prototype.readMessage, proto.litrpc.Feature.deserializeBinaryFromReader, "", new proto.litrpc.Feature());
         });
      break;
    default:
      reader.skipField();
...
/**
 * Clears values from the map. The map will be non-null.
 * @return {!proto.litrpc.ListAutopilotFeaturesResponse} returns this
 */
...
/**
 * @param {!(string|Uint8Array)} value
 * @return {!proto.litrpc.RevokeAutopilotSessionRequest} returns this
 */
...
proto.litrpc.Feature.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    requiresUpgrade: jspb.Message.getBooleanFieldWithDefault(msg, 5, false),
...
proto.litrpc.Feature.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 3:
      ...
      reader.readMessage(value, function(message, reader) {
        jspb.Map.deserializeBinary(message, reader, jspb.BinaryReader.prototype.readString, jspb.BinaryReader.prototype.readMessage, proto.litrpc.RuleValues.deserializeBinaryFromReader, "", new proto.litrpc.RuleValues());
         });
      break;
    case 4:
...
/**
 * @param {string} value
 * @return {!proto.litrpc.Feature} returns this
 */
...
proto.litrpc.Feature.prototype.clearPermissionsListList = function() {
  return this.setPermissionsListList([]);
};
...
/**
 * @param {boolean} value
 * @return {!proto.litrpc.RuleValues} returns this
 */
...
/**
 * @param {string} value
 * @return {!proto.litrpc.Permissions} returns this
 */
