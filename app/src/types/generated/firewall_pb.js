...
proto.litrpc.PrivacyMapConversionRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    realToPseudo: jspb.Message.getBooleanFieldWithDefault(msg, 1, false),
...
/**
 * @param {boolean} value
 * @return {!proto.litrpc.PrivacyMapConversionRequest} returns this
 */
...
/**
 * @param {string} value
 * @return {!proto.litrpc.PrivacyMapConversionResponse} returns this
 */
...
proto.litrpc.ListActionsRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    reversed: jspb.Message.getBooleanFieldWithDefault(msg, 7, false),
    countTotal: jspb.Message.getBooleanFieldWithDefault(msg, 8, false),
    sessionId: msg.getSessionId_asB64(),
...
/**
 * @param {string} value
 * @return {!proto.litrpc.ListActionsRequest} returns this
 */
 ...
 * @return {!proto.litrpc.ListActionsResponse} returns this
*/
