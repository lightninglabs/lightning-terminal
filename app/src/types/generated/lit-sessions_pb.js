...
proto.litrpc.RuleValue.prototype.setChannelConstraint = function(value) {
  jspb.Message.setOneofWrapperField(this, 9, proto.litrpc.RuleValue.oneofGroups_[0], value);
};


proto.litrpc.RuleValue.prototype.clearChannelConstraint = function() {
  this.setChannelConstraint(undefined);
};
...
proto.litrpc.ChannelConstraint.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    privateAllowed: jspb.Message.getFieldWithDefault(msg, 4, false),
    publicAllowed: jspb.Message.getFieldWithDefault(msg, 5, false)
  };
