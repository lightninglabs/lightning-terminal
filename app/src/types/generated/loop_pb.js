...
proto.looprpc.LiquidityParameters.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 10:
      var value = /** @type {boolean} */ (reader.readBool());
      msg.setAutoLoopOut(value);
      break;
    case 11:
      var value = /** @type {number} */ (reader.readUint64());
      msg.setAutoOutBudgetSat(value);
      break;
    case 12:
      var value = /** @type {number} */ (reader.readUint64());
      msg.setAutoOutBudgetStartSec(value);
      break;
    case 13:
      var value = /** @type {number} */ (reader.readUint64());
...
proto.looprpc.LiquidityParameters.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getAutoOutBudgetStartSec();
  if (f !== 0) {
    writer.writeUint64(
      12,
      f
...
/**
 * optional bool auto_loop_out = 10;
 * Note that Boolean fields may be set to 0/1 when serialized from a Java server.
 * You should avoid comparisons like {@code val === true/false} in those cases.
 * @return {boolean}
 */
proto.looprpc.LiquidityParameters.prototype.getAutoLoopOut = function() {
  return /** @type {boolean} */ (jspb.Message.getFieldWithDefault(this, 10, false));
};


/** @param {boolean} value */
proto.looprpc.LiquidityParameters.prototype.setAutoLoopOut = function(value) {
  jspb.Message.setField(this, 10, value);
};


/**
 * optional uint64 auto_out_budget_sat = 11;
 * @return {number}
 */
proto.looprpc.LiquidityParameters.prototype.getAutoOutBudgetSat = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 11, 0));
};


/** @param {number} value */
proto.looprpc.LiquidityParameters.prototype.setAutoOutBudgetSat = function(value) {
  jspb.Message.setField(this, 11, value);
};


/**
 * optional uint64 auto_out_budget_start_sec = 12;
 * @return {number}
 */
proto.looprpc.LiquidityParameters.prototype.getAutoOutBudgetStartSec = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 12, 0));
};


/** @param {number} value */
proto.looprpc.LiquidityParameters.prototype.setAutoOutBudgetStartSec = function(value) {
  jspb.Message.setField(this, 12, value);
};
 ...
 * @const
 */
proto.looprpc.SuggestSwapsResponse.repeatedFields_ = [1];
