...
/**
 * @param {string} value
 * @return {!proto.poolrpc.TxOut} returns this
 */
...
proto.poolrpc.OrderMatchSignBegin.prototype.clearPrevOutputsList = function() {
  return this.setPrevOutputsList([]);
};
...
proto.poolrpc.ServerBid.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    unannouncedChannel: jspb.Message.getBooleanFieldWithDefault(msg, 8, false),
    zeroConfChannel: jspb.Message.getBooleanFieldWithDefault(msg, 9, false)
  };
