 ...
 * @return {number}
 */
proto.poolrpc.OrderMatchFinalize.prototype.getHeightHint = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 3, 0));
};


/** @param {number} value */
proto.poolrpc.OrderMatchFinalize.prototype.setHeightHint = function(value) {
  jspb.Message.setField(this, 3, value);
};
...
/**
 * optional uint32 chan_type = 12;
 * @return {number}
 */
proto.poolrpc.ServerOrder.prototype.getChanType = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 12, 0));
};


/** @param {number} value */
proto.poolrpc.ServerOrder.prototype.setChanType = function(value) {
...
proto.poolrpc.TermsResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 4:
      ...
      reader.readMessage(value, function(message, reader) {
        jspb.Map.deserializeBinary(message, reader, jspb.BinaryReader.prototype.readUint32, jspb.BinaryReader.prototype.readBool);
         });
      break;
    case 5:
      var value = /** @type {number} */ (reader.readUint32());
