...
type AccountsClient interface {
	...
	// litcli: `accounts creditaccount`
	// CreditAccount increases the balance of an existing account in the account
	// database.
	CreditAccount(ctx context.Context, in *UpdateAccountBalanceRequest, opts ...grpc.CallOption) (*Account, error)
	// litcli: `accounts debitaccount`
	// DebitAccount decreases the balance of an existing account in the account
	// database.
	DebitAccount(ctx context.Context, in *UpdateAccountBalanceRequest, opts ...grpc.CallOption) (*Account, error)
...
func (c *accountsClient) CreditAccount(ctx context.Context, in *UpdateAccountBalanceRequest, opts ...grpc.CallOption) (*Account, error) {
	out := new(Account)
...
func (c *accountsClient) DebitAccount(ctx context.Context, in *UpdateAccountBalanceRequest, opts ...grpc.CallOption) (*Account, error) {
	out := new(Account)
...
type AccountsServer interface {
	...
	// CreditAccount increases the balance of an existing account in the account
	// database.
	CreditAccount(context.Context, *UpdateAccountBalanceRequest) (*Account, error)
	// litcli: `accounts debitaccount`
	// DebitAccount decreases the balance of an existing account in the account
	// database.
	DebitAccount(context.Context, *UpdateAccountBalanceRequest) (*Account, error)
	// litcli: `accounts list`
	// ListAccounts returns all accounts that are currently stored in the account
	// database.
...
func (UnimplementedAccountsServer) CreditAccount(context.Context, *UpdateAccountBalanceRequest) (*Account, error) {
	return nil, status.Errorf(codes.Unimplemented, "method CreditAccount not implemented")
}
func (UnimplementedAccountsServer) DebitAccount(context.Context, *UpdateAccountBalanceRequest) (*Account, error) {
...
func _Accounts_CreditAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AccountsServer).CreditAccount(ctx, req.(*UpdateAccountBalanceRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
func _Accounts_DebitAccount_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AccountsServer).DebitAccount(ctx, req.(*UpdateAccountBalanceRequest))
	}
	return interceptor(ctx, in, info, handler)
}
