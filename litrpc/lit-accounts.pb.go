...
type UpdateAccountBalanceRequest struct {
	...
	// The amount by which the account's balance should be updated.
...
func (x *UpdateAccountBalanceRequest) GetAmount() uint64 {
	if x != nil {
		return x.Amount
	}
	return 0
...
var file_lit_accounts_proto_rawDesc = []byte{
	...
	0x05, 0x6c, 0x61, 0x62, 0x65, 0x6c, 0x22, 0x5b, 0x0a, 0x1b, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65,
	...
	0x75, 0x6e, 0x74, 0x22, 0x15, 0x0a, 0x13, 0x4c, 0x69, 0x73, 0x74, 0x41, 0x63, 0x63, 0x6f, 0x75,
	...
	0x73, 0x65, 0x32, 0xfa, 0x03, 0x0a, 0x08, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x73, 0x12,
	...
	0x0d, 0x43, 0x72, 0x65, 0x64, 0x69, 0x74, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x23,
	0x2e, 0x6c, 0x69, 0x74, 0x72, 0x70, 0x63, 0x2e, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x41, 0x63,
	...
	0x6f, 0x75, 0x6e, 0x74, 0x12, 0x44, 0x0a, 0x0c, 0x44, 0x65, 0x62, 0x69, 0x74, 0x41, 0x63, 0x63,
	0x6f, 0x75, 0x6e, 0x74, 0x12, 0x23, 0x2e, 0x6c, 0x69, 0x74, 0x72, 0x70, 0x63, 0x2e, 0x55, 0x70,
	0x64, 0x61, 0x74, 0x65, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x42, 0x61, 0x6c, 0x61, 0x6e,
	0x63, 0x65, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x0f, 0x2e, 0x6c, 0x69, 0x74, 0x72,
	0x70, 0x63, 0x2e, 0x41, 0x63, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x49, 0x0a, 0x0c, 0x4c, 0x69,
...
var file_lit_accounts_proto_depIdxs = []int32{
	...
	6,  // 6: litrpc.Accounts.CreditAccount:input_type -> litrpc.UpdateAccountBalanceRequest
	6,  // 7: litrpc.Accounts.DebitAccount:input_type -> litrpc.UpdateAccountBalanceRequest
	7,  // 8: litrpc.Accounts.ListAccounts:input_type -> litrpc.ListAccountsRequest
	9,  // 9: litrpc.Accounts.AccountInfo:input_type -> litrpc.AccountInfoRequest
	10, // 10: litrpc.Accounts.RemoveAccount:input_type -> litrpc.RemoveAccountRequest
	1,  // 11: litrpc.Accounts.CreateAccount:output_type -> litrpc.CreateAccountResponse
	2,  // 12: litrpc.Accounts.UpdateAccount:output_type -> litrpc.Account
	2,  // 13: litrpc.Accounts.CreditAccount:output_type -> litrpc.Account
	2,  // 14: litrpc.Accounts.DebitAccount:output_type -> litrpc.Account
	8,  // 15: litrpc.Accounts.ListAccounts:output_type -> litrpc.ListAccountsResponse
	2,  // 16: litrpc.Accounts.AccountInfo:output_type -> litrpc.Account
	11, // 17: litrpc.Accounts.RemoveAccount:output_type -> litrpc.RemoveAccountResponse
