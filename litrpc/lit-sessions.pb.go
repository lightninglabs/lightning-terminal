...
type Session struct {
	...
	// If set, this is the local_pub_key of a Session that this Session is linked
	// to. The session's will share the same privacy mapper and, if this is an
	// Autopilot session, then the Autopilot server will be informed that the
	// sessions are linked on session creation.
	PrevSessionLocalPub []byte `protobuf:"bytes,17,opt,name=prev_session_local_pub,json=prevSessionLocalPub,proto3" json:"prev_session_local_pub,omitempty"`
	...
	// same as the ID.
	GroupId []byte `protobuf:"bytes,18,opt,name=group_id,json=groupId,proto3" json:"group_id,omitempty"`
}
...
func (x *Session) GetPrevSessionLocalPub() []byte {
	if x != nil {
		return x.PrevSessionLocalPub
	}
	return nil
}
...
var file_lit_sessions_proto_rawDesc = []byte{
	...
	0x96, 0x07, 0x0a, 0x07, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x0e, 0x0a, 0x02, 0x69,
	...
	0x30, 0x01, 0x52, 0x09, 0x72, 0x65, 0x76, 0x6f, 0x6b, 0x65, 0x64, 0x41, 0x74, 0x12, 0x33, 0x0a,
	0x16, 0x70, 0x72, 0x65, 0x76, 0x5f, 0x73, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x5f, 0x6c, 0x6f,
	0x63, 0x61, 0x6c, 0x5f, 0x70, 0x75, 0x62, 0x18, 0x11, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x13, 0x70,
	0x72, 0x65, 0x76, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x4c, 0x6f, 0x63, 0x61, 0x6c, 0x50,
	0x75, 0x62, 0x12, 0x19, 0x0a, 0x08, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x5f, 0x69, 0x64, 0x18, 0x12,
	0x20, 0x01, 0x28, 0x0c, 0x52, 0x07, 0x67, 0x72, 0x6f, 0x75, 0x70, 0x49, 0x64, 0x1a, 0x59, 0x0a,
