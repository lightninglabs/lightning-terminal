...
func loadAndValidateConfig() (*Config, error) {
	...
	if cfg.LetsEncrypt && cfg.LetsEncryptHost == "" {
		return nil, fmt.Errorf("host must be set when using let's " +
			"encrypt")
	}
...
func loadConfigFile(preCfg *Config, usageMessage string) (*Config, error) {
	...
	// file within it.
	configFileDir := lnd.CleanAndExpandPath(preCfg.LitDir)
	configFilePath := lnd.CleanAndExpandPath(preCfg.ConfigFile)
	if configFileDir != defaultLitDir {
