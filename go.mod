...
require (
	...
	github.com/lightninglabs/loop v0.28.9-beta
...
// Semver seems to prefer the rc2 version otherwise.
replace github.com/lightningnetwork/lnd => github.com/lightningnetwork/lnd v0.18.4-beta
