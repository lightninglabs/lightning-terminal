...
require (
	...
	github.com/lightninglabs/faraday v0.2.16-alpha.0.20260625120509-f99e4a3004b6
	github.com/lightninglabs/faraday/frdrpc v1.0.2-0.20260625120509-f99e4a3004b6
