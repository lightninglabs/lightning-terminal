...
require (
	...
	github.com/lightninglabs/taproot-assets v0.6.1-0.20250625084903-74953ffd5ce3
	github.com/lightninglabs/taproot-assets/taprpc v1.0.9-0.20250625084903-74953ffd5ce3
