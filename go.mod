...
require (
	...
	github.com/lightninglabs/taproot-assets v0.6.1-0.20250813154159-11d73c0e7e1c
	github.com/lightninglabs/taproot-assets/taprpc v1.0.10-0.20250813154159-11d73c0e7e1c
