...
require (
	...
	github.com/lightninglabs/taproot-assets v0.6.0-rc1.0.20250509160137-a1e7b9b28678
	github.com/lightninglabs/taproot-assets/taprpc v1.0.3-0.20250509160137-a1e7b9b28678
