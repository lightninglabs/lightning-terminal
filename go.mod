...
require (
	...
	github.com/lightninglabs/taproot-assets v0.5.2-0.20250307124156-41ae7d2c31a2
	github.com/lightningnetwork/lnd v0.18.0-beta.rc4.0.20250307101700-a5f54d1d6b2e
