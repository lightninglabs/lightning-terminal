...
type SQLKVStoreQueries interface {
	...
	DeleteSessionGroupKVStoreRecord(ctx context.Context, arg sqlc.DeleteSessionGroupKVStoreRecordParams) error
	...
	GetSessionGroupKVStoreRecord(ctx context.Context, arg sqlc.GetSessionGroupKVStoreRecordParams) ([]byte, error)
	...
	UpdateSessionGroupKVStoreRecord(ctx context.Context, arg sqlc.UpdateSessionGroupKVStoreRecordParams) error
...
func (s *sqlKVStore) Set(ctx context.Context, key string, value []byte) error {
	...
	case groupID.Valid:
		return s.queries.UpdateSessionGroupKVStoreRecord(
			ctx, sqlc.UpdateSessionGroupKVStoreRecordParams{
				Key:     key,
				Value:   value,
				Perm:    s.params.perm,
				GroupID: groupID,
...
func (s *sqlKVStore) Del(ctx context.Context, key string) error {
	...
	case groupID.Valid:
		return s.queries.DeleteSessionGroupKVStoreRecord(
			ctx, sqlc.DeleteSessionGroupKVStoreRecordParams{
				Key:     key,
				Perm:    s.params.perm,
				GroupID: groupID,
				RuleID:  ruleID,
...
func (s *sqlKVStore) get(ctx context.Context, key string) ([]byte, error) {
	...
	case groupID.Valid:
		return s.queries.GetSessionGroupKVStoreRecord(
			ctx, sqlc.GetSessionGroupKVStoreRecordParams{
				Key:     key,
				Perm:    s.params.perm,
				GroupID: groupID,
				RuleID:  ruleID,
