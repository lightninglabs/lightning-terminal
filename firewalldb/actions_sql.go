...
func unmarshalAction(ctx context.Context, db SQLActionQueries,
	...
	// we'll still populate the MacaroonIdentifier to maintain compatibility
	// with any existing callers.
	//
	// TODO(viktor): Remove the MacaroonIdentifier field when we longer need
	// to be compatible with the kvdb version.
